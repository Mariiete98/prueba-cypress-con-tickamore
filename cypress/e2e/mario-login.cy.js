...
describe(LoginData.titulos.login, () => {
    ...
    beforeEach(() => {
        ...
        // Aquí las llaves del Json tienen dos valores, entonces se obtiene Array. 
        // Hay que crear otro valor, un objeto, y que busque algo del que tenga lo que queremos obtener
        cy.fixture('login').then((data) => {
            const usuario = data.find(objetoUsuario => objetoUsuario.user === 'Mario');
            contrasenaError = usuario.pass;
        });
    ...
    it.only('TEST 3.2. Aceptar Cookies predeterminadas y abrir Login. Campo usuario vacío', () => {
        ...
        cy.wait(1000);
            ...
            LoginFunciones.insertarPassword(contrasena);
            cy.wait(1000);
